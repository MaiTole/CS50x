...
unsigned int hash(const char *word)
{
    ...
    if (isalpha(word[1]) == 0) {
    ...
    else if (isalpha(word[1]) != 0 && isalpha(word[2]) == 0) {
        int char1 = word[1];
        ...
        multiple = ((char0 * char1) + (char0 * char2) + (char1 * char2));
    }
    else if (isalpha(word[1]) != 0 && isalpha(word[2]) != 0 && isalpha(word[3]) != 0) {
    int char1 = word[1];
    if (64 < char1 && char1 < 91) {
        char1 = char1 + 32;
    }
    ...
    multiple = ((char0 * char1) + (char0 * char2) + (char1 * char2) + (char2 * char3));
    }
    return (multiple - 9310); // TODO
}
